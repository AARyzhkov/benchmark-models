...
os.environ['OPENMC_CROSS_SECTIONS'] = "/mnt/e/Codes/NuclearData/OpenMC/cendl-3.2-hdf5/cross_sections.xml"
...
clad.add_nuclide('C12',  3.5740E-04)
...
structure.add_nuclide('C12',  3.8254E-04)
...
natural_absorber.add_nuclide('C12',   2.7000E-02)
...
enriched_absorber.add_nuclide('C12',   2.7000E-02)
...
refl_mat.add_nuclide('C12',  2.8308E-04)
