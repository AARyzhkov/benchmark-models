...
###############################################################################
inner_fuel_1 = openmc.Material(name='Inner fuel - 20.11 cm', temperature=1200.00)
...
inner_fuel_2 = openmc.Material(name='Inner fuel - 40.22 cm', temperature=1200.00)
...
inner_fuel_3 = openmc.Material(name='Inner fuel - 60.33 cm', temperature=1200.00)
...
inner_fuel_4 = openmc.Material(name='Inner fuel - 80.44 cm', temperature=1200.00)
...
inner_fuel_5 = openmc.Material(name='Inner fuel - 100.55 cm', temperature=1200.00)
...
outer_fuel_1 = openmc.Material(name='Outer fuel - 20.11 cm', temperature=1200.00)
...
outer_fuel_2 = openmc.Material(name='Outer fuel - 40.22 cm', temperature=1200.00)
...
outer_fuel_3 = openmc.Material(name='Outer fuel - 60.33 cm', temperature=1200.00)
...
outer_fuel_4 = openmc.Material(name='Outer fuel - 80.44 cm', temperature=1200.00)
...
outer_fuel_5 = openmc.Material(name='Outer fuel - 100.55 cm', temperature=1200.00)
