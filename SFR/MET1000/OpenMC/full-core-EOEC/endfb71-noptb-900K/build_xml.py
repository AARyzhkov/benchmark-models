...
###############################################################################
inner_fuel_1 = openmc.Material(name='Inner fuel - 17.16 cm', temperature=900)
...
inner_fuel_2 = openmc.Material(name='Inner fuel - 34.33 cm', temperature=900)
...
inner_fuel_3 = openmc.Material(name='Inner fuel - 51.49 cm', temperature=900)
...
inner_fuel_4 = openmc.Material(name='Inner fuel - 68.66 cm', temperature=900)
...
inner_fuel_5 = openmc.Material(name='Inner fuel - 85.82 cm', temperature=900)
...
outer_fuel_1 = openmc.Material(name='Outer fuel - 17.16 cm', temperature=900)
...
outer_fuel_2 = openmc.Material(name='Outer fuel - 34.33 cm', temperature=900)
...
outer_fuel_3 = openmc.Material(name='Outer fuel - 51.49 cm', temperature=900)
...
outer_fuel_4 = openmc.Material(name='Outer fuel - 68.66 cm', temperature=900)
...
outer_fuel_5 = openmc.Material(name='Outer fuel - 85.82 cm', temperature=900)
