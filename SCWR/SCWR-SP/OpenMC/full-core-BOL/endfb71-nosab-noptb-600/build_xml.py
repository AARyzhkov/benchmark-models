...
steel_water = openmc.Material(name = 'Baffle', temperature = 600)
...
steel_water_in = openmc.Material(name = 'Bottom Reflector', temperature = 600)
...
steel_water_out = openmc.Material(name = 'Top Reflector', temperature = 600)
