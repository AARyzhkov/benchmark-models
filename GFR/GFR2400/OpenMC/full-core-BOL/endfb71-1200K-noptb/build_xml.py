...
###############################################################################
inner_fuel_1 = openmc.Material(name = 'Inner fuel - 33 cm', temperature = 1200)
...
inner_fuel_2 = openmc.Material(name = 'Inner fuel - 66 cm', temperature = 1200)
...
inner_fuel_3 = openmc.Material(name = 'Inner fuel - 99 cm', temperature = 1200)
...
inner_fuel_4 = openmc.Material(name = 'Inner fuel - 132 cm', temperature = 1200)
...
inner_fuel_5 = openmc.Material(name = 'Inner fuel - 165 cm', temperature = 1200)
...
outer_fuel_1 = openmc.Material(name = 'Outer fuel - 33 cm', temperature = 1200)
...
outer_fuel_2 = openmc.Material(name = 'Outer fuel - 66 cm', temperature = 1200)
...
outer_fuel_3 = openmc.Material(name = 'Outer fuel - 99 cm', temperature = 1200)
...
outer_fuel_4 = openmc.Material(name = 'Outer fuel - 132 cm', temperature = 1200)
...
outer_fuel_5 = openmc.Material(name = 'Outer fuel - 165 cm', temperature = 1200)
