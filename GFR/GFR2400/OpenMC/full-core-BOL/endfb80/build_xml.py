...
os.environ['OPENMC_CROSS_SECTIONS'] = "/mnt/e/Codes/NuclearData/OpenMC/endfb-viii.0-hdf5/cross_sections.xml"

###############################################################################
#                 Exporting to OpenMC materials.xml File
###############################################################################
inner_fuel_1 = openmc.Material(name = 'Inner fuel - 33 cm', temperature = 1236)
...
inner_fuel_2 = openmc.Material(name = 'Inner fuel - 66 cm', temperature = 1236)
...
inner_fuel_3 = openmc.Material(name = 'Inner fuel - 99 cm', temperature = 1236)
...
inner_fuel_4 = openmc.Material(name = 'Inner fuel - 132 cm', temperature = 1236)
...
inner_fuel_5 = openmc.Material(name = 'Inner fuel - 165 cm', temperature = 1236)
...
outer_fuel_1 = openmc.Material(name = 'Outer fuel - 33 cm', temperature = 1236)
...
outer_fuel_2 = openmc.Material(name = 'Outer fuel - 66 cm', temperature = 1236)
...
outer_fuel_3 = openmc.Material(name = 'Outer fuel - 99 cm', temperature = 1236)
...
outer_fuel_4 = openmc.Material(name = 'Outer fuel - 132 cm', temperature = 1236)
...
outer_fuel_5 = openmc.Material(name = 'Outer fuel - 165 cm', temperature = 1236)
...
#                          Pin
#####################################################################
inner_pin_1_cell    = openmc.Cell(fill=inner_fuel_1, region=-fuel_r & +pin_0_plane)
...
outer_pin_1_cell    = openmc.Cell(fill=outer_fuel_1, region=-fuel_r & +pin_0_plane)
