...
###############################################################################
fuel = openmc.Material(name='Fuel', temperature=900.00)
fuel.add_nuclide('Na23' , 4.6534E-03)
fuel.add_nuclide('Cl35' , 2.0549E-06)
fuel.add_nuclide('Cl37' , 2.0547E-02)
fuel.add_nuclide('Th232', 1.9358E-03)
fuel.add_nuclide('U235' , 2.5137E-04)
fuel.add_nuclide('U238' , 1.7030E-03)
fuel.add_nuclide('Np237', 4.8079E-05)
fuel.add_nuclide('Pu238', 2.0605E-05)
fuel.add_nuclide('Pu239', 3.5029E-04)
fuel.add_nuclide('Pu240', 1.6408E-04)
fuel.add_nuclide('Pu241', 8.1657E-05)
fuel.add_nuclide('Pu242', 5.1131E-05)
fuel.add_nuclide('Am241', 2.5947E-05)
fuel.add_nuclide('Am243', 1.4500E-05)
fuel.add_nuclide('Cm244', 6.1052E-06)
fuel.add_nuclide('Cm245', 7.6315E-07)
fuel.volume = 17977422.67

fertile = openmc.Material(name='Fertile Salt', temperature=923.15)
fertile.add_nuclide('Na23' , 7.2804E-03)
fertile.add_nuclide('Cl35' , 1.9761E-06)
fertile.add_nuclide('Cl37' , 1.9759E-02)
fertile.add_nuclide('Th232', 3.1202E-03)
